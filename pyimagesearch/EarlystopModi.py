...
class EarlyStoppingM(Callback):
    ...
    # Arguments
        ...
        patience: number of epochs with no improvement
            after which training will be stopped. It will be at least the cycle_lenght + 1
    ...
    def __init__(self,
        ...
        super(EarlyStoppingM, self).__init__()
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        for lay in self.model.layers:
            if lay.name == "batch_normalization_1":
                print(lay.name)
